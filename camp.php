  ...
  if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    ?>
      ...
      ?>
          ...
          Swal.fire({
          icon: 'success',
            title: '  تم الحجز في حملة الإحسان رقم الحملة : 1001',
            text: '  رقم التواصل : 0559322812',
            showConfirmButton: false,
            timer: 4950,
          })
    ...
    <div class="depertment_area">
        <div class="container">
          ...
          الحملات
                  ...
                  <h1
                    style="    text-align: center;  color: #b49164;  margin: 15px;font-size: 25px;font-weight: bolder;">
                    المتبقى من الحجوزات : 
          ...
          <a  style="margin-left:1px; font-size:25px;" href="#" class="btn_sign" data-animation="fadeInLeft" data-delay="0.5s" style="margin-left:0;" id="get-started"  >احجز الأن <i class="ti-arrow-right"></i></a>
                           ...
                           <div class="center-wrap">
                             <form class="section text-center  " action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST">
                                      <input type="hidden" name="add_reservation" value="1">
                                        ...
                                        <h4 class="mb-4 pb-3 h2" style=" color:#ececec; font-size: 35px;">  بيانات الحجز</h4></h4>
                                        <div class="paymentt" style="width:100%;     display: flex;    justify-content: space-around; margin:8px;">
                                        ...
                                        <div class="form-group">
                                          <input type="text" name="name" class="form-style" placeholder=" الأسم كما يظهر على البطاقة " id="name" autocomplete="off" required>
                                        </div>   
                                        <div class="form-group mt-2">
                                          <input type="number" name="number" class="form-style" placeholder="رقم البطاقة " id="number" autocomplete="off" required>
                                        </div>
                                        <div class="form-group mt-2">
                                        <select name="type" id="" class="form-style" required>
                                         ...
                                         <div class="form-group mt-2">
                                           <input type="month"  class="form-style" style="width:59%; "   id="number" autocomplete="off" required>
                                           <input type="number" name="number" class="form-style" style="width:39%;"  placeholder="رمز CVC" id="number" autocomplete="off" required>
                                        </div>
                                       ...
                                       <input type="hidden" name="payment" value="1">
                                        ...
                                        <input type="submit" name="reservation" value="تأكيد الدفع" class="btn mt-4" style="border: solid 1px #fff;" >
    ...
    <div class="row align-items-center" style="margin-top:15px;">
        ...
        <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
              ...
              <div >
                            ...
                            <iframe class="mapss" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3629.082451223209!2d46.484457500000005!3d24.5518127!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e2f22e4d1ca828d%3A0x3b09c56ebd7b9d3f!2sAlhejaz%20Gas%20Station!5e0!3m2!1sen!2ssa!4v1684272368057!5m2!1sen!2ssa" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                  ...
                  <div class="tab-pane fade" id="Astrology" role="tabpanel" aria-labelledby="Astrology-tab">
                    ...
                    <div class="row align-items-center" style="margin-top:55px;">
                        ...
                        <div class="dept_info txtr"> 
                            ...
                            <p id="pTx"  style="margin-bottom:0px; margin-top: 10px; margin-right:25px;">
                             <ul style="margin-right:50px;">
                                <li> المنشآت الصحية في المشاعر المقدسة تقدم كافة الخدمات الوقائية والعلاجية والاسعافية لضيوف الرحمن, عبر تقنيات حديثة وتجهيز تطبية متقدمة. وتقدم المراكز خدمات الرعاية الصحية الأولية لحجاج بيت الله الحرام , والعاملين في المشاعر المقدسة, بالإضافة الى تقديم الخدمات الإسعافية, والتدخل لإنقاذ الحالات الطارئة والاسعافية.</li>
                            </ul>
                            </p>
                              <h3 id="headTx">
                                    رقم الهلال الأحمر  :
                    ...
                    <div class="containerMap">
                      <div class="map-container">
                             <h3 id="headTx">
                              <strong> مستفى الحرس الوطني الميداني </strong> <br>
                              <br> 
                              رقم المستشفى  :
                            </h3>
                            <h3 id="headTx"  style="margin-bottom:0px; margin-top: 10px; margin-right:25px;">
                      ...
                      <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3714.129642480003!2d39.9006021!3d21.424148700000003!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x15c20157b6a86e45%3A0x937e7799e1a3005!2sHealth%20Center%2012!5e0!3m2!1sen!2ssa!4v1685560548965!5m2!1sen!2ssa" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                      </div>
                      <div class="map-container">
                              <h3 id="headTx">
                                      <strong> مستفى صحي منى  </strong> <br>
<br>
                                    رقم المستشفى  :
                      ...
                      <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d14858.271301969613!2d39.8906!3d21.406915000000005!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x15c2041a585beb5d%3A0x92ba7a9353bf0afc!2sField%20National%20Guard%20Hospital!5e0!3m2!1sen!2ssa!4v1685559250378!5m2!1sen!2ssa" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                      </div>
                    </div>
